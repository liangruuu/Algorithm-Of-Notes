...
int main() {
  ...
  // 测试3 测试存在包含大量相同元素的数组
  // 但此时, 对于含有大量相同元素的数组,
  // 我们的快速排序算法再次退化成了O(n^2)级别的算法 思考一下为什么在这种情况下,
  // 快排退化成了O(n^2)的算法? :)
  //    cout<<"Test for random array, size = "<<n<<", random range
  //    [0,10]"<<endl; arr1 = SortTestHelper::generateRandomArray(n,0,10); arr2
  //    = SortTestHelper::copyIntArray(arr1, n);
  //
  //    SortTestHelper::testSort("Merge Sort", mergeSort, arr1, n);
  //    SortTestHelper::testSort("Quick Sort", quickSort, arr2, n);
  //
